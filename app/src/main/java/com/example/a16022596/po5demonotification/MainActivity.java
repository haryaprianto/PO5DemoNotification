package com.example.a16022596.po5demonotification;
...
import static com.example.a16022596.po5demonotification.R.id.button;

public class MainActivity extends AppCompatActivity {int requestCode = 123;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNotify1 = (Button) findViewById(R.id.button);
